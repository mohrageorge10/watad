...
class ProgressSiteUpdatesView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => sl<ProgressSiteUpdatesCubit>()..fetchProgressSiteUpdates(),
      child: Scaffold(
              ...
              if (state is ProgressSiteUpdatesLoading) {
                ...
                return Center(
                  child: AppEmptyStateWidget(
                    ...
                    buttonTitle: "Retry",
                    onButtonPressed: () {
                      context.read<ProgressSiteUpdatesCubit>().fetchProgressSiteUpdates();
                    },
                  ),
                );
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  Text(
                                    "Site Updates (${data.totalUploads})",
                                    style: AppTextStyles.font16SemiBold.copyWith(
                              ...
                              if (data.siteUpdatePhotos.isEmpty)
                                const Center(
                                  child: Padding(
